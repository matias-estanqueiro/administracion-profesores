...
const getPrimary = computed(() => {
    if (custmizer.actTheme === 'GREEN_THEME') {
        return themeColors.GREEN_THEME.colors.primary;
    } else if (custmizer.actTheme === 'RED_THEME') {
        return themeColors.RED_THEME.colors.primary;
    } else if (custmizer.actTheme === 'YELLOW_THEME') {
        return themeColors.YELLOW_THEME.colors.primary;
    } else if (custmizer.actTheme === 'GREY_THEME') {
        return themeColors.GREY_THEME.colors.primary;
    ...
    } else if (custmizer.actTheme === 'DARK_YELLOW_THEME') {
        return DarkThemeColors.DARK_YELLOW_THEME.colors.primary;
    } else if (custmizer.actTheme === 'DARK_GREY_THEME') {
        return DarkThemeColors.DARK_GREY_THEME.colors.primary;
...
const getLightPrimary = computed(() => {
    if (custmizer.actTheme === 'GREEN_THEME') {
        ...
        return themeColors.YELLOW_THEME.colors.lightprimary;
    } else if (custmizer.actTheme === 'GREY_THEME') {
        return themeColors.GREY_THEME.colors.lightprimary;
    } else if (custmizer.actTheme === 'ORANGE_THEME') {
    ...
    if (custmizer.actTheme === 'DARK_GREEN_THEME') {
        ...
        return DarkThemeColors.DARK_YELLOW_THEME.colors.lightprimary;
    } else if (custmizer.actTheme === 'DARK_GREY_THEME') {
        return DarkThemeColors.DARK_GREY_THEME.colors.lightprimary;
    } else if (custmizer.actTheme === 'DARK_ORANGE_THEME') {
...
const getSecondary = computed(() => {
    if (custmizer.actTheme === 'GREEN_THEME') {
        ...
        return themeColors.YELLOW_THEME.colors.secondary;
    } else if (custmizer.actTheme === 'GREY_THEME') {
        return themeColors.GREY_THEME.colors.secondary;
    } else if (custmizer.actTheme === 'ORANGE_THEME') {
        ...
        return DarkThemeColors.DARK_YELLOW_THEME.colors.secondary;
    } else if (custmizer.actTheme === 'DARK_GREY_THEME') {
        return DarkThemeColors.DARK_GREY_THEME.colors.secondary;
    } else if (custmizer.actTheme === 'DARK_ORANGE_THEME') {
...
const getLightSecondary = computed(() => {
    if (custmizer.actTheme === 'GREEN_THEME') {
        ...
        return themeColors.YELLOW_THEME.colors.lightsecondary;
    } else if (custmizer.actTheme === 'GREY_THEME') {
        return themeColors.GREY_THEME.colors.lightsecondary;
    } else if (custmizer.actTheme === 'ORANGE_THEME') {
    ...
    if (custmizer.actTheme === 'DARK_GREEN_THEME') {
        ...
        return DarkThemeColors.DARK_YELLOW_THEME.colors.lightsecondary;
    } else if (custmizer.actTheme === 'DARK_GREY_THEME') {
        return DarkThemeColors.DARK_GREY_THEME.colors.lightsecondary;
    } else if (custmizer.actTheme === 'DARK_ORANGE_THEME') {
...
const getLight100 = computed(() => {
    if (
        ...
        custmizer.actTheme === 'YELLOW_THEME' ||
        custmizer.actTheme === 'GREY_THEME' ||
        ...
        custmizer.actTheme === 'DARK_YELLOW_THEME' ||
        custmizer.actTheme === 'DARK_GREY_THEME' ||
