        ...
        <v-card-text>
            ...
            <v-table class="month-table mt-5">
                <template v-slot:default>
                    ...
                    <tbody>
                        <tr v-for="item in product_PerformanceData" :key="item.leadname" :class="item.activestate" class="month-item">
                            <td>
                                <div class="d-flex align-center">
                                    <v-avatar size="40"> <img :src="item.img" :alt="item.img" width="40" /></v-avatar>
                                    <div class="mx-3">
